<template>
    <div>
        <div>
            ...
            <div>
                <div class="title">缩写</div>
                <div class="content">
                    <p>v-bind 缩写</p>
                    <!-- 完整语法 -->
                    <div v-bind:href="url">vbind href</div>
...
<script lang="ts" src="./template2.ts">
